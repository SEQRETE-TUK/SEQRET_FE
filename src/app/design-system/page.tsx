...
const colors = [
  { name: "Primary 600", value: "#4F46E5", role: "결정 CTA · 선택 · 진행", className: "bg-primary-600" },
  { name: "Primary 700", value: "#4338CA", role: "CTA hover · 강조", className: "bg-primary-700" },
  { name: "Primary 50", value: "#EEF2FF", role: "정보 · 선택 배경", className: "bg-primary-50" },
  { name: "Canvas", value: "#F4F5F9", role: "화면 배경", className: "bg-canvas" },
  { name: "Surface", value: "#FFFFFF", role: "콘텐츠 표면", className: "bg-white" },
  { name: "Ink 900", value: "#191927", role: "주요 텍스트", className: "bg-ink-900" },
  { name: "Ink 600", value: "#4B4B5C", role: "보조 텍스트", className: "bg-ink-600" },
  { name: "Line", value: "#E9EAF2", role: "구분선 · 테두리", className: "bg-line" },
  { name: "Success", value: "#17A46B", role: "완료 · 통과", className: "bg-success" },
  { name: "Warning", value: "#F5A623", role: "모름 · 대기", className: "bg-warning" },
  { name: "Danger", value: "#E5484D", role: "증가 · 거절 · 삭제", className: "bg-danger" },
];
...
export default function DesignSystemPage() {
  return (
    <main className="h-dvh overflow-y-auto overscroll-y-contain bg-canvas text-ink-900">
        ...
        <div className="min-w-0 px-5 py-10 lg:px-12 lg:py-14">
          ...
          <section className="scroll-mt-8 pt-16" id="foundations">
            ...
            <div className="mt-6 overflow-hidden rounded-2xl border border-line bg-white">
              <div className="grid grid-cols-3 border-b border-line bg-[#FAFAFC] px-5 py-3 text-[11px] font-bold text-ink-400">
                <span>Category</span><span>Value</span><span>Usage</span>
              </div>
              {[
                ["Spacing", "8pt grid", "12 related · 16 row · 20 card · 32 section"],
          ...
          <section className="scroll-mt-8 pt-16" id="components">
            ...
            <div className="mt-7 overflow-hidden rounded-2xl border border-line bg-white">
              {[
                ...
                ["Native form", "input · textarea", "공통 토큰과 접근성 규칙 적용"],
