        ...
        <main className="flex flex-1 flex-col px-[var(--content-gutter)] pb-40 pt-10" id="main-content">
          <div className="my-auto w-full">
            <section aria-labelledby="role-entry-title">
              <h1 className="text-ui-section font-black tracking-[var(--tracking-display)]" id="role-entry-title">{entryStep === "name" ? "어떻게 불러드릴까요?" : entryStep === "code" ? "초대 코드로 연결할게요" : entryStep === "choice" ? "어떻게 시작할까요?" : "어떤 역할로 시작할까요?"}</h1>
            </section>
