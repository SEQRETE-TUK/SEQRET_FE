  ...
  return (
    <main className="mobile-stage" id="main-content">
      <div className="mobile-frame px-5">
        <header className="app-safe-header pb-3"><strong className="text-lg font-black tracking-[var(--tracking-display)] text-primary-800">SEQRET</strong></header>
        <section className="pt-14">
          ...
          <h1 className="mt-2 max-w-[18rem] text-ui-section leading-9 font-extrabold tracking-[var(--tracking-display)]">페이지를 찾을 수 없어요</h1>
