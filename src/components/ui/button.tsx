...
const buttonVariants = cva(
  "inline-flex touch-manipulation items-center justify-center gap-2 rounded-xl border text-[15px] font-bold transition-colors select-none disabled:pointer-events-none disabled:bg-[#E4E6ED] disabled:text-ink-400 focus-visible:outline focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-primary-400 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
