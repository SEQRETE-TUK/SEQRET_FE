...
export function AgreementOverview({ children, fallbackLocationConditions, hasIssue = false, onOpenHistory, scope }: { children?: ReactNode; fallbackLocationConditions?: ScopeLocationConditions[]; hasIssue?: boolean; onOpenHistory: () => void; scope: ScopeReview }) {
...
const conditionLabels: Record<string, string> = { residence_type: "주거 형태", floor: "층수", elevator: "엘리베이터", stairs: "계단", ladder: "사다리차", parking_access: "주차", carry_distance: "운반 거리", access_note: "접근 메모" };
